...
export const MobileNav = ({ children, className, visible }: MobileNavProps) => {
  return (
    <motion.div
      ...
      className={cn(
        "relative z-50 mx-auto flex w-full max-w-[calc(100vw-2rem)] flex-col items-center justify-between bg-transparent px-4 py-2 md:hidden",
        visible && "bg-white/80 dark:bg-neutral-950/80",
        className,
      )}
    >
...
export const MobileNavToggle = ({
  ...
  return isOpen ? (
    <IconX className="text-foreground h-6 w-6" onClick={onClick} />
  ) : (
    <IconMenu2 className="text-foreground h-6 w-6" onClick={onClick} />
  );
};
...
export const NavbarButton = ({
  ...
  const variantStyles = {
    ...
    gradient:
      "bg-gradient-to-b from-[#D94A45] to-[#B83736] text-white shadow-[0px_2px_0px_0px_rgba(255,255,255,0.3)_inset]"
  };
